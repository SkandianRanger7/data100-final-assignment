...
grad_exp_formula <- grad_rate ~ instr_exp_per_student * public_private 

grad_ratio_lm_full <- linear_reg() |> set_engine("lm")
grad_ratio_formula <- grad_rate ~ student_faculty_ratio * public_private 
...
rmse_comparison_table <- tibble::tribble(
  ~Model, ~Model_Type, ~RMSE_Validation, 
