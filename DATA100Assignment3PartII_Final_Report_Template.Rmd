...
storms_ice <- inner_join(storms, sea_ice) |>
  group_by(ObservYear, region) |>
  summarize(
    min_ice = min(ice_extent, na.rm = TRUE), 
    region, 
...
ggplot(storms_ice, aes(x=avg_lon, y=min_ice, colour = region)) +
  geom_jitter() +
